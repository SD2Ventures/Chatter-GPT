// Utilities: symbol extraction, crypto maps, helpers

const CRYPTO_SET = new Set([
  "BTC","ETH","SOL","XRP","ADA","DOGE","SHIB","AVAX","BNB",
  "MATIC","DOT","LTC","LINK","ATOM","NEAR","APT","SUI","ARB","OP","BCH","ETC"
]);
...
// Pretty name helpers (basic)
const COIN_NAME = {
  BTC: "Bitcoin", ETH: "Ethereum", SOL: "Solana", XRP: "XRP",
  ADA: "Cardano", DOGE: "Dogecoin", SHIB: "Shiba Inu", AVAX: "Avalanche",
  BNB: "BNB", MATIC: "Polygon", DOT: "Polkadot", LTC: "Litecoin",
  LINK: "Chainlink", ATOM: "Cosmos", NEAR: "NEAR", APT: "Aptos",
  SUI: "Sui", ARB: "Arbitrum", OP: "Optimism", BCH: "Bitcoin Cash", ETC: "Ethereum Classic"
};
...
export function scoreFromZ(z, evidenceCount=0, eventBoost=0) {
  // Map z to 0..100, with small bumps for evidence/event
  const base = 50 + 20*z;
